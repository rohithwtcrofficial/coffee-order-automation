...
<body style="margin:0; padding:0; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color:#f3f4f6;">
    ...
    <tr>
      <td align="center">
        <table width="600" cellspacing="0" cellpadding="0" style="max-width:600px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:40px 24px 24px 24px; text-align:center; background:#fef2f2; border-bottom:3px solid #ef4444;">
              <div style="display:inline-block; width:64px; height:64px; background:#ef4444; border-radius:50%; margin-bottom:16px; line-height:64px; text-align:center;">
                <span style="font-size:32px; color:#ffffff;">✕</span>
              </div>
              <h2 style="margin:0 0 8px 0; font-size:24px; font-weight:700; color:#dc2626;">
                Order Cancelled
              </h2>
              <p style="margin:0; font-size:16px; color:#991b1b;">
                Your order has been cancelled, <strong>${data.customerName}</strong>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 24px;">
              ...
              <p style="margin:0 0 20px 0; font-size:16px; color:#374151; line-height:1.6;">
                Your order has been <strong>cancelled successfully</strong>. We're sorry to see this order go, but we understand that plans change. Your refund has been initiated.
              </p>

              <!-- Refund Information -->
              <table width="100%" cellspacing="0" cellpadding="0" style="background:#fef2f2; border-radius:10px; padding:24px; margin-bottom:32px; border:1px solid #fecaca;">
                <tr>
                  <td>
                    <table width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding-bottom:16px;">
                          <h3 style="margin:0; font-size:18px; font-weight:700; color:#991b1b;">
                            💳 Refund Details
                          </h3>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:12px 0; border-top:1px solid #fecaca;">
                          <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>
              ...
              <!-- Refund Timeline -->
              <table width="100%" cellspacing="0" cellpadding="0" style="margin-top:32px; border-left:4px solid #3b82f6; background:#dbeafe; padding:20px;">
                <tr>
                  <td>
                            ...
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#1e3a8a;">
                                  <strong>Refund Initiated</strong> - Your refund has been processed from our end
                                </p>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="padding:8px 0;">
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#1e3a8a;">
                                  <strong>Bank Processing</strong> - Your bank/payment provider will process the refund
                                </p>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="padding:8px 0;">
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#1e3a8a;">
                                  <strong>Credit to Account</strong> - Refund will be credited within 5-7 business days
                                </p>
                              </td>
                            </tr>
                          </table>
                ...
                <tr>
                  <td>
                    <p style="margin:0 0 12px 0; font-size:14px; color:#92400e; line-height:1.6;">
                      <strong style="color:#78350f;">💬 Have Questions?</strong><br/>
                      If you have any concerns about your cancellation or refund, or if there was an issue with your order experience, please don't hesitate to reach out. We're here to help and always looking to improve!
                    </p>
                    <p style="margin:0; font-size:13px; color:#92400e; line-height:1.6;">
                      📋 For more details, view our <a href="https://westernterraincoffee.com/p/refund-policy" style="color:#b45309; text-decoration:underline; font-weight:600;">Refund Policy</a>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <!-- Sweet Message Before Featured Products -->
          <tr>
            <td style="padding:0 24px 32px 24px;">
              <table width="100%" cellspacing="0" cellpadding="0" style="background:linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius:12px; padding:24px; text-align:center; border:2px solid #fbbf24;">
                <tr>
                  <td>
                    <p style="margin:0 0 8px 0; font-size:24px;">☕</p>
                    <h3 style="margin:0 0 12px 0; font-size:18px; font-weight:700; color:#78350f;">
                      We'd Love to See You Again!
                    </h3>
                    <p style="margin:0; font-size:15px; color:#92400e; line-height:1.6;">
                      While we're sad to see this order go, we hope you'll consider exploring our other premium coffee selections. Your perfect brew might be just a click away! ☕
                    </p>
                  </td>
                </tr>
              </table>
  ...
  return {
    subject: `Order Cancelled – #${data.orderNumber} | Western Terrain Coffee`,
    html,
  };
}