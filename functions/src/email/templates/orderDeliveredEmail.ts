...
<body style="margin:0; padding:0; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color:#f3f4f6;">
    ...
    <tr>
      <td align="center">
        <table width="600" cellspacing="0" cellpadding="0" style="max-width:600px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
          ...
          <!-- Success Message -->
          <tr>
            <td style="padding:40px 24px 24px 24px; text-align:center; background:#f0fdf4; border-bottom:3px solid #22c55e;">
              <div style="display:inline-block; width:64px; height:64px; background:#22c55e; border-radius:50%; margin-bottom:16px; line-height:64px; text-align:center;">
                <span style="font-size:32px;">✓</span>
              </div>
              <h2 style="margin:0 0 8px 0; font-size:24px; font-weight:700; color:#15803d;">
                Delivered Successfully!
              </h2>
              <p style="margin:0; font-size:16px; color:#166534;">
                Your order has arrived, <strong>${data.customerName}</strong>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 24px;">
              ...
              <p style="margin:0 0 20px 0; font-size:16px; color:#374151; line-height:1.6;">
                Great news! Your order has been <strong>delivered successfully</strong>. We hope you enjoy your premium coffee experience. Thank you for choosing Western Terrain Coffee Roasters!
              </p>
              ...
              <table width="100%" cellspacing="0" cellpadding="0" style="background:#f0fdf4; border-radius:10px; padding:20px; margin-bottom:32px; border:1px solid #bbf7d0;">
                ${data.productNames
                  .map(
                    (name) => `
                <tr>
                            ...
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#92400e;">
                                  <strong>Airtight Storage</strong> - Keep your coffee in an airtight container to preserve freshness
                                </p>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="padding:8px 0;">
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#92400e;">
                                  <strong>Cool & Dark</strong> - Store away from direct sunlight, heat, and moisture
                                </p>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="padding:8px 0;">
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#92400e;">
                                  <strong>Clean Utensils</strong> - Always use a clean, dry spoon to maintain quality
                                </p>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td style="padding:8px 0;">
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              <td style="width:24px; vertical-align:top;">
                                <span style="display:inline-block; width:20px; height:20px; background:#f59e0b; color:#ffffff; text-align:center; border-radius:50%; font-size:12px; font-weight:700; line-height:20px;">4</span>
                              </td>
                              <td style="padding-left:12px;">
                                <p style="margin:0; font-size:14px; color:#92400e;">
                                  <strong>Brew Fresh</strong> - For best taste, brew within 2-3 weeks of opening
                                </p>
                              </td>
                            </tr>
                          </table>
                    ...
                    <table cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding:0 8px;">
                          <a href="${orderLink}"
                             style="display:inline-block; background:#111827; color:#ffffff; padding:16px 32px; text-decoration:none; border-radius:8px; font-weight:600; font-size:16px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                            View Order Details
                          </a>
                        </td>
                        <td style="padding:0 8px;">
                          <a href="https://westernterraincoffee.com/categories/"
                             style="display:inline-block; background:#059669; color:#ffffff; padding:16px 32px; text-decoration:none; border-radius:8px; font-weight:600; font-size:16px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                            Shop Again
                          </a>
                        </td>
                      </tr>
  ...
  return {
    subject: `Order Delivered – #${data.orderNumber} | Western Terrain Coffee`,
    html,
  };
}